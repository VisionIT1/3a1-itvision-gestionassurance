...
public class Sinistre {
    ...
    public String toString() {
        return "Sinistre{" + "Code_sinistre=" + Code_sinistre + ", Date_declaration=" + Date_declaration + ", Date_sinistre=" + Date_sinistre + ", Lieu_sinistre=" + Lieu_sinistre + ", Numero_sinistre=" + Numero_sinistre + ", Domage_mat=" + Domage_mat + ", Domage_corps=" + Domage_corps + ", Code_assureur=" + Code_assureur + ", Description=" + Description + '}';
    }

    public Sinistre(int Code_sinistre, Date Date_declaration, Date Date_sinistre, String Lieu_sinistre, int Numero_sinistre, int Domage_mat, int Domage_corps, int Code_assureur, String Description) {
        ...
        this.Code_assureur = Code_assureur;
    ...
    public int getCode_assureur() {
        return Code_assureur;
    }

    public void setCode_assureur(int Code_assureur) {
        this.Code_assureur = Code_assureur;
    }
