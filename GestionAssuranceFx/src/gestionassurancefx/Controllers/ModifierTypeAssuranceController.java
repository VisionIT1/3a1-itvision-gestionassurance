...
public class ModifierTypeAssuranceController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        initColumnsVehicule();
        tbvehicule.setItems(vc.afficherVehiculeparID(1));
        ...
        for (Vehicule v :vc.afficherVehiculeparID(1)){
        ...
        txtannconst.setText(""+v.getAnnne_consruct());
         ...
         // si c'est un voyage
            initColumnsVoyage();
            tbvoyage.setItems(voyc.afficherVoyageparId(1));
           /* c3vehicule.setVisible(false);
            ...
            for (Voyage voy : voyc.afficherVoyageparId(1)){
            ...
            tbhabitat.setItems(hc.afficherHabitationparId(1));
           ...
           tbhabitat.setVisible(true);
            ...
            tbvoyage.setVisible(false);
            tbmarque.setVisible(false);
            for (Habitation h : hc.afficherHabitationparId(1)){
    ...
    private void validerModification(ActionEvent event) {
        ...
        for (Vehicule vv : vc.afficherVehiculeparID(1)){
            System.out.println(vv);
        Vehicule v=new Vehicule(1,txtimmat.getText(), Integer.parseInt(txtpf.getText()),Float.parseFloat(txtvalneuf.getText()),Float.parseFloat( txtvalven.getText()), Integer.parseInt(txtannconst.getText()),k, vv.getId_garantie());
        ...
        for (Voyage voy : voyc.afficherVoyageparId(1) ){
             if( cbdursej.getSelectionModel().getSelectedItem().trim().equals("entre 1 et 3 mois")){
                    ...
                    Voyage voy1=new Voyage(1,txtdest.getText(),3,Integer.parseInt(txtage.getText()));
             ...
             if (cbdursej.getSelectionModel().getSelectedItem().trim().equals("entre 3 et 9 mois")){
                  Voyage voy1=new Voyage(1,txtdest.getText(),9,Integer.parseInt(txtage.getText()));
             ...
             if (cbdursej.getSelectionModel().getSelectedItem().trim().equals("entre 9 et 12 mois")){
                 Voyage voy1=new Voyage(1,txtdest.getText(),12,Integer.parseInt(txtage.getText()));
                  System.out.println(voy1);
                 voyc.modifierVoyage(voy1);
                    tbvoyage.getItems().clear();
                    tbvoyage.setItems(voyc.afficherVoyageparId(1));
              ...
              if (cbdursej.getSelectionModel().getSelectedItem().trim().equals("Superieur a 1 an")){
                   Voyage voy1=new Voyage(1,txtdest.getText(),1,Integer.parseInt(txtage.getText()));
                   voyc.modifierVoyage(voy1);
                    tbvoyage.getItems().clear();
                    tbvoyage.setItems(voyc.afficherVoyageparId(1));
              }
        ...
        for (Habitation hh: hc.afficherHabitationparId(1)){
            
           if (rbvilla.isSelected()){
                    if(rbbvo.isSelected()){
                        if (rbsysao.isSelected()){
                            Habitation h=new Habitation (1,1,Integer.parseInt(txtnbp.getText()),Float.parseFloat(txtcapmob.getText()),1,rbvilla.getText());
                            hc.modifierHabitation(h);
                            System.out.println(h);
                        }else{
                            Habitation h=new Habitation (1,1,Integer.parseInt(txtnbp.getText()),Float.parseFloat(txtcapmob.getText()),0,rbvilla.getText());
                           hc.modifierHabitation(h);
                           System.out.println(h);
                        }
                    }else{
                        if (rbsysao.isSelected()){
                            Habitation h=new Habitation (1,0,Integer.parseInt(txtnbp.getText()),Float.parseFloat(txtcapmob.getText()),1,rbvilla.getText());
                           hc.modifierHabitation(h);
                           System.out.println(h);
                        }else{
                            Habitation h=new Habitation (1,0,Integer.parseInt(txtnbp.getText()),Float.parseFloat(txtcapmob.getText()),0,rbvilla.getText());
                       hc.modifierHabitation(h);
                       System.out.println(h);
                        }
                    }
                    ...
                    if(rbbvn.isSelected()){
                        if (rbsysao.isSelected()){
                            Habitation h=new Habitation (1,1,Integer.parseInt(txtnbp.getText()),Float.parseFloat(txtcapmob.getText()),1,rbappart.getText());
                           hc.modifierHabitation(h);
                           System.out.println(h);
                        }else{
                            Habitation h=new Habitation (1,1,Integer.parseInt(txtnbp.getText()),Float.parseFloat(txtcapmob.getText()),0,rbappart.getText());
                          hc.modifierHabitation(h);
                          System.out.println(h);
                        }
                    }else{
                        if (rbsysao.isSelected()){
                            Habitation h=new Habitation (1,0,Integer.parseInt(txtnbp.getText()),Float.parseFloat(txtcapmob.getText()),1,rbappart.getText());
                        hc.modifierHabitation(h);
                        System.out.println(h);
                        }else{
                            Habitation h=new Habitation (1,0,Integer.parseInt(txtnbp.getText()),Float.parseFloat(txtcapmob.getText()),0,rbappart.getText());
                          hc.modifierHabitation(h);
                          System.out.println(h);
                        }  
                    }
