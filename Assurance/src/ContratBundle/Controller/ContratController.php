...
class ContratController extends Controller
{
    ...
    public function afficheCAction()
    {
        $em=$this->getDoctrine()->getManager();
        $contrats=$em->getRepository("ContratBundle:Contrat")->findAll();
        return $this->render('@ContratBundle\Contrat\afficheC.html.twig',array('c'=>$contrats));
    }

    function AjouterCAction(Request $request){
        $contrat = new Contrat();
        ...
        return $this->render('@ContratBundle/Contrat/ajout.html.twig',array('form'=>$form->createView()));
    }
